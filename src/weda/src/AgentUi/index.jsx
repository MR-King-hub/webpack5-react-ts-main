    ...
    items: [
      {
        ...
        attributes: {
          ":data":
            'Object.assign({"bot":{"botId":""},"llmConfig":{"model":"","provider":"","reasonModel":"","reasonModelText":""}}, $comp.props.data)',
                ...
                items: [
                  {
                    ...
                    attributes: {
                      name: "td:error-circle",
                      style: { fontSize: "5rem", color: "rgb(95, 114, 146)" },
                    },
                    directives: { ":if": true },
                    extra: {
                      staticResourceAttribute: ["src"],
